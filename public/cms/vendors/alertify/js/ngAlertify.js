        ...
        function e() {
            var t = {
                ...
                setup: function (t) {
                    ...
                    l && ("string" == typeof this.promptPlaceholder && (r ? r.textContent = this.promptPlaceholder : l.placeholder = this.promptPlaceholder), "string" == typeof this.promptValue && (l.value = this.promptValue));
                    var s;
                    return "function" == typeof Promise ? s = new Promise(e) : e(), this.parent.appendChild(o), setTimeout(function () {
