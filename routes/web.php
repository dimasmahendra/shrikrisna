...
Route::post('/webcam/store', [App\Http\Controllers\InternalController::class, 'index'])->name('webcam.capture');
    ...
    Route::prefix("admin")->group(function () {
        ...
        Route::group(['prefix' => 'customer', 'middleware' => ['htmlMinifier']], function() {
            ...
            Route::prefix("measurement")->group(function () {
                ...
                Route::get('/destroy/{id}', [App\Http\Controllers\Cms\MeasurementController::class, 'destroy'])->name('category.measurement.destroy');
